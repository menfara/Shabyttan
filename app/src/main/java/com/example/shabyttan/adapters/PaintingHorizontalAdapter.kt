...
import com.example.shabyttan.databinding.ItemPaintingBinding

class PaintingHorizontalAdapter(private val images: List<Int>) :
    RecyclerView.Adapter<PaintingHorizontalAdapter.ViewHolder>() {

    class ViewHolder(private val binding: ItemPaintingBinding) : RecyclerView.ViewHolder(binding.root) {
